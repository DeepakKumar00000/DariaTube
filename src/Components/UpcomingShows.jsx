...
//   return (
//     <div className="bg-white text-black px-4 md:px-12 lg:px-24 py-16">
//       <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-10">
//         <div>
//           {/* <p className="text-yellow-500 font-bold font-serif">Upcoming Shows</p> */}
...
//         {/* <button className="mt-4 md:mt-0 bg-black text-white px-6 py-2 rounded-md font-bold hover:bg-gray-800">
//           All Shows
//         </button> */}
